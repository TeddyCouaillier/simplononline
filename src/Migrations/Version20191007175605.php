 ...
 */
final class Version20191007175605 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, publisher_id INT NOT NULL, language_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, link VARCHAR(255) NOT NULL, published_at DATETIME NOT NULL, github VARCHAR(255) DEFAULT NULL, INDEX IDX_232B318C40C86FCE (publisher_id), INDEX IDX_232B318C82F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, moderator_id INT NOT NULL, title VARCHAR(60) NOT NULL, created_at DATETIME NOT NULL, github VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, website VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, completed TINYINT(1) NOT NULL, INDEX IDX_2FB3D0EED0AFA354 (moderator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE codeblock (id INT AUTO_INCREMENT NOT NULL, publisher_id INT NOT NULL, language_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, slug VARCHAR(255) NOT NULL, published_at DATETIME NOT NULL, INDEX IDX_E8D58DF840C86FCE (publisher_id), INDEX IDX_E8D58DF882F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE task (id INT AUTO_INCREMENT NOT NULL, project_id INT DEFAULT NULL, title VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, type INT NOT NULL, INDEX IDX_527EDB25166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_files (id INT AUTO_INCREMENT NOT NULL, receiver_id INT NOT NULL, files_id INT NOT NULL, sender_id INT NOT NULL, date_send DATETIME NOT NULL, seen TINYINT(1) NOT NULL, INDEX IDX_E4F7BB01CD53EDB6 (receiver_id), INDEX IDX_E4F7BB01A3E65B2F (files_id), INDEX IDX_E4F7BB01F624B39D (sender_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vote (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, game_id INT NOT NULL, like_type TINYINT(1) DEFAULT NULL, INDEX IDX_5A108564A76ED395 (user_id), INDEX IDX_5A108564E48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE help (id INT AUTO_INCREMENT NOT NULL, publisher_id INT NOT NULL, language_id INT DEFAULT NULL, link VARCHAR(255) NOT NULL, title VARCHAR(75) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_8875CAC40C86FCE (publisher_id), INDEX IDX_8875CAC82F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE schedule (id INT AUTO_INCREMENT NOT NULL, begin_at DATETIME NOT NULL, end_at DATETIME DEFAULT NULL, title VARCHAR(255) NOT NULL, important TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE brief (id INT AUTO_INCREMENT NOT NULL, publisher_id INT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, slug LONGTEXT NOT NULL, link VARCHAR(255) DEFAULT NULL, published_at DATETIME NOT NULL, INDEX IDX_1FBB100740C86FCE (publisher_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE game ADD CONSTRAINT FK_232B318C40C86FCE FOREIGN KEY (publisher_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE codeblock DROP FOREIGN KEY FK_E8D58DF882F1BAF4');
        ...
        $this->addSql('ALTER TABLE codeblock DROP FOREIGN KEY FK_E8D58DF840C86FCE');
        ...
        $this->addSql('ALTER TABLE user_deadline DROP FOREIGN KEY FK_57CA90F2A76ED395');
        ...
        $this->addSql('ALTER TABLE brief DROP FOREIGN KEY FK_1FBB100740C86FCE');

 ...
 */
final class Version20190726094418 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_files ADD files_id INT NOT NULL, CHANGE sender_id sender_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user_files ADD CONSTRAINT FK_E4F7BB01A3E65B2F FOREIGN KEY (files_id) REFERENCES files (id)');
        $this->addSql('CREATE INDEX IDX_E4F7BB01A3E65B2F ON user_files (files_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_E4F7BB01A3E65B2F ON user_files');
        $this->addSql('ALTER TABLE user_files DROP files_id, CHANGE sender_id sender_id INT DEFAULT NULL');
    }
}

 ...
 */
final class Version20190916154931 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE codeblock ADD slug VARCHAR(255) NOT NULL, ADD published_at DATETIME NOT NULL, CHANGE language_id language_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE codeblock DROP slug, DROP published_at, CHANGE language_id language_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE correction CHANGE project_id project_id INT DEFAULT NULL');

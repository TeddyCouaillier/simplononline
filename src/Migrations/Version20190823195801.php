 ...
 */
final class Version20190823195801 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE help CHANGE language_id language_id INT DEFAULT NULL, CHANGE title title VARCHAR(75) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE correction CHANGE project_id project_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE help CHANGE language_id language_id INT DEFAULT NULL, CHANGE title title VARCHAR(50) NOT NULL COLLATE utf8mb4_unicode_ci');

 ...
 */
final class Version20190729195633 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE training_course ADD sent_at DATETIME NOT NULL, CHANGE status status VARCHAR(50) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE training_course DROP sent_at, CHANGE status status VARCHAR(100) NOT NULL COLLATE utf8mb4_unicode_ci');

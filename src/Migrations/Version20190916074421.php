 ...
 */
final class Version20190916074421 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE codeblock ADD title VARCHAR(255) NOT NULL, CHANGE language_id language_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE codeblock DROP title, CHANGE language_id language_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE correction CHANGE project_id project_id INT DEFAULT NULL');

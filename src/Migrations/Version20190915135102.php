 ...
 */
final class Version20190915135102 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE task DROP description, CHANGE project_id project_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE schedule CHANGE end_at end_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE subtask CHANGE task_id task_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE task ADD description LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE project_id project_id INT DEFAULT NULL');

 ...
 */
final class Version20190725184030 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_files ADD important TINYINT(1) NOT NULL, CHANGE sender_id sender_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE promotion CHANGE nickname nickname VARCHAR(100) DEFAULT NULL');
        $this->addSql('ALTER TABLE files DROP urgent');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE files ADD urgent TINYINT(1) NOT NULL');
        ...
        $this->addSql('ALTER TABLE user_files DROP important, CHANGE sender_id sender_id INT DEFAULT NULL');
    }
}

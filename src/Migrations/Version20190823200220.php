 ...
 */
final class Version20190823200220 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE help DROP description, CHANGE language_id language_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE correction CHANGE project_id project_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE help ADD description LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE language_id language_id INT DEFAULT NULL');

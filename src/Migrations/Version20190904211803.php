 ...
 */
final class Version20190904211803 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_files CHANGE important seen TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE task CHANGE project_id project_id INT DEFAULT NULL, CHANGE title title VARCHAR(50) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE subtask CHANGE task_id task_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE task CHANGE project_id project_id INT DEFAULT NULL, CHANGE title title VARCHAR(100) NOT NULL COLLATE utf8mb4_unicode_ci');
        ...
        $this->addSql('ALTER TABLE user_files CHANGE seen important TINYINT(1) NOT NULL');
    }
}

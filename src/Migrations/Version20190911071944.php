 ...
 */
final class Version20190911071944 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vote DROP dead_link, CHANGE like_type like_type TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vote ADD dead_link TINYINT(1) NOT NULL, CHANGE like_type like_type TINYINT(1) NOT NULL');
    }
}

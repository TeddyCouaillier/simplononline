 ...
 */
final class Version20190806130738 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project ADD moderator_id INT NOT NULL, CHANGE github github VARCHAR(255) DEFAULT NULL, CHANGE website website VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE project ADD CONSTRAINT FK_2FB3D0EED0AFA354 FOREIGN KEY (moderator_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_2FB3D0EED0AFA354 ON project (moderator_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_2FB3D0EED0AFA354 ON project');
        $this->addSql('ALTER TABLE project DROP moderator_id, CHANGE github github VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE website website VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
